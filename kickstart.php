<?php define('KICKSTARTVERSION','2.3.2'); ?>
<?php
/**
 * @package JoomlaPack
 ...
 */
define('CHUNKSIZE',		1048576);			// Default pass-through chunk size (used when extracting uncompressed data): 1Mb
define('MAXBATCHSIZE',	1048576);			// Maximum archive chunk's size to be processed at once: 1Mb
define('MAXBATCHFILES', 39);				// Maximum files to process at once: 40 (yes, you must define one _less_ than the value you want; 0 means extract each file on its own, which is dead slow)
...
define('TEMPDIR', dirname(__FILE__) );		// Default temporary directory (directory of kickstart.php)
// Note on TEMPDIR: Normally, it should pick up the directory where kickstart.php lives in. However,
// on some hosts you can't use the site's root as a temporary directory. If this is the case, just
// create a directory named tempextract, change its permissions to 0777 and modify the above line
// to read:
// define('TEMPDIR',	'tempextract');
...
<div id="maincontainer"><?php if (AUTOMODE == 1) { ?>
